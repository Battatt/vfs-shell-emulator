...
java -cp out Main -v ./test_vfs -script testScripts/script.txt
echo ""

# Test 2: Stop on error
echo "========================================"
echo "Test 2: Stop on error behavior"
java -cp out Main -v ./test_vfs -script testScripts/scriptError.txt
echo ""
